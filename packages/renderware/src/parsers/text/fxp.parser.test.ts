...
// The real effects.fxp (regenerated by `npm run test:fixtures` into tests/original/), used for the systems below.
const FXP_PATH = join(process.cwd(), 'tests', 'original', 'models', 'effects.fxp');
